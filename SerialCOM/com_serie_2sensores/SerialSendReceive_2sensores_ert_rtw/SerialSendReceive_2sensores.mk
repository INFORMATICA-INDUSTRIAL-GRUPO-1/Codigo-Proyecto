###########################################################################
## Makefile generated for component 'SerialSendReceive_2sensores'. 
## 
## Makefile     : SerialSendReceive_2sensores.mk
## Generated on : Tue Dec 29 17:00:29 2020
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SerialSendReceive_2sensores.elf
...
PRODUCT_NAME              = SerialSendReceive_2sensores
MAKEFILE                  = SerialSendReceive_2sensores.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Lenovo/Desktop/SerialCOM/com_serie_2sensores
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SerialSendReceive_2sensores.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(START_DIR)/SerialSendReceive_2sensores_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2020b/toolbox/target/shared/EXTERN~1/include
...
DEFINES_STANDARD = -DMODEL=SerialSendReceive_2sensores -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.o : $(START_DIR)/SerialSendReceive_2sensores_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/SerialSendReceive_2sensores_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SerialSendReceive_2sensores_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SerialSendReceive_2sensores.o : $(START_DIR)/SerialSendReceive_2sensores_ert_rtw/SerialSendReceive_2sensores.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SerialSendReceive_2sensores_data.o : $(START_DIR)/SerialSendReceive_2sensores_ert_rtw/SerialSendReceive_2sensores_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/SerialSendReceive_2sensores_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
