 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Sun Jan 03 16:49:36 2021
 */
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const uint8_T *enc_I = (const uint8_T *) mxGetData(PARAM_DEF0(S));
    const uint8_T *pinA_I = (const uint8_T *) mxGetData(PARAM_DEF1(S));
    const uint8_T *pinB_I = (const uint8_T *) mxGetData(PARAM_DEF2(S));
    const uint8_T *enc_D = (const uint8_T *) mxGetData(PARAM_DEF3(S));
    const uint8_T *pinA_D = (const uint8_T *) mxGetData(PARAM_DEF4(S));
    const uint8_T *pinB_D = (const uint8_T *) mxGetData(PARAM_DEF5(S));
    
    MisEncoders_Outputs_wrapper(pos, xD, enc_I, p_width0, pinA_I, p_width1, pinB_I, p_width2, enc_D, p_width3, pinA_D, p_width4, pinB_D, p_width5);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    MisEncoders_Update_wrapper(pos, xD, enc_I, p_width0, pinA_I, p_width1, pinB_I, p_width2, enc_D, p_width3, pinA_D, p_width4, pinB_D, p_width5);
