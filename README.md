...
This IoT software has been developed as the final project for the subject "Informática Industrial". Some technologies studied during the semester are being used in this project, for example, MQTT, Node-RED or Arduino.
