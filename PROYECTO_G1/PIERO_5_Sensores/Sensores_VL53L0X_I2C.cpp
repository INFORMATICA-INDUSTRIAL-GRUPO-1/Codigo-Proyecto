 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Tue Jan 19 16:11:37 2021
 */
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       Sensor1
...
/* Output Port  1 */
#define OUT_PORT_1_NAME       Sensor2
...
/* Output Port  2 */
#define OUT_PORT_2_NAME       Sensor3
...
{
    int32_T *Sensor1 = (int32_T *) ssGetOutputPortRealSignal(S, 0);
    int32_T *Sensor2 = (int32_T *) ssGetOutputPortRealSignal(S, 1);
    int32_T *Sensor3 = (int32_T *) ssGetOutputPortRealSignal(S, 2);
    const real_T *xD = ssGetDiscStates(S);

    Sensores_VL53L0X_I2C_Outputs_wrapper(Sensor1, Sensor2, Sensor3, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    Sensores_VL53L0X_I2C_Update_wrapper(Sensor1, Sensor2, Sensor3, xD);
